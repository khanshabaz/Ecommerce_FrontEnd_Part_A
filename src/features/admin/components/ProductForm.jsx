          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md ring-gray-300 focus-within:ring-2 focus-within:-ring-inset-2 focus-within:ring-indigo-600">
                    <input
                      id="title"
                      {...register("title", {
                      ...
                      type="text"
                      className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400  sm:text-sm/6"
                    />
                  </div>
                </div>
              </div>
